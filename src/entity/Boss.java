...
public class Boss extends Entity {
    ...
    protected BufferedImage no_active, image;
    private int time = 10000;
    private int delay_bite = 10000;
    int[][] curMap;
    boolean[][] prior;
    ...
    public void getImage() {
        try {
            no_active = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/enermy/B_NoActive.png")));
            up1 = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/enermy/B_static1.png")));
            up2 = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/enermy/B_static2.png")));
            left1 = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/enermy/B_left.png")));
            right1 = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/enermy/B_right.png")));
